 ...
 * example values in api/firefly-iii-2.1.0-v1.yaml (Transaction / TransactionSplit /
 * TransactionSplitStore schemas).
 *
 * Notes:
 *  - The read-side TransactionSplit schema in 2.1.0 has NO piggy_bank_id property;
