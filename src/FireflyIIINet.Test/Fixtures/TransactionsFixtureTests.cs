 ...
 * example values in api/firefly-iii-6.3.0-v1.yaml (Transaction / TransactionSplit /
 * TransactionSplitStore schemas).
 *
 * Notes:
 *  - The read-side TransactionSplit schema in 6.3.0 has NO piggy_bank_id property;
