 ...
 * example values in api/firefly-iii-2.0.12-v1.yaml (Transaction / TransactionSplit /
 * TransactionSplitStore schemas).
 *
 * Notes:
 *  - The read-side TransactionSplit schema in 2.0.12 has NO piggy_bank_id property;
