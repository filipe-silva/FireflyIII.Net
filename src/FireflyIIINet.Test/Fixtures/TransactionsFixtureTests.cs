 ...
 * example values in api/firefly-iii-6.2.2-v1.yaml (Transaction / TransactionSplit /
 * TransactionSplitStore schemas).
 *
 * Notes:
 *  - The read-side TransactionSplit schema in 6.2.2 has NO piggy_bank_id property;
