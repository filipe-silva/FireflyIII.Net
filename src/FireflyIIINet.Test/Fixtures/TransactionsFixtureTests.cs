 ...
 * example values in api/firefly-iii-2.0.7-v1.yaml (Transaction / TransactionSplit /
 * TransactionSplitStore schemas).
 *
 * Notes:
 *  - The read-side TransactionSplit schema in 2.0.7 has NO piggy_bank_id property;
