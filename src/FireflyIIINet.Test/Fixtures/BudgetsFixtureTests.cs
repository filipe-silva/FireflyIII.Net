/*
 * Fixture tests built from the Firefly III OpenAPI spec examples (v1: firefly-iii-2.0.2-v1.yaml,
 * v2: firefly-iii-2.0.2-v2.yaml), asserting the wire format maps onto the generated models.
 *
...
namespace FireflyIIINet.Test.Fixtures
{
    public class BudgetsFixtureTests
    {
        ...
        private const string BudgetLimitV2ReadJson = """
        {
          "type": "budget_limits",
          "id": "2",
          "attributes": {
        ...
        [Fact]
        public void BudgetLimitV2Read_Deserializes_V2_Spec_Example()
        {
            var read = JsonSerializer.Deserialize<BudgetLimitV2Read>(BudgetLimitV2ReadJson, SerializerOptions.Default);
