/*
 * Fixture tests built from the Firefly III OpenAPI spec examples (v1: firefly-iii-6.2.9-v1.yaml,
 * v2: firefly-iii-6.2.9-v2.yaml), asserting the wire format maps onto the generated models.
 *
