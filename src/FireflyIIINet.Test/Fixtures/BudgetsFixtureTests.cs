/*
 * Fixture tests built from the Firefly III OpenAPI spec examples (v1: firefly-iii-2.0.5-v1.yaml,
 * v2: firefly-iii-2.0.5-v2.yaml), asserting the wire format maps onto the generated models.
 *
