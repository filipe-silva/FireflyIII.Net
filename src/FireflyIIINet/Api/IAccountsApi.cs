...
namespace FireflyIIINet.Api
{
    public interface IAccountsApi
    {
        ...
        Task<TransactionArray> ListTransactionByAccountV2(string id, [Header("X-Trace-Id")] Guid? xTraceId = null, int? page = null, int? limit = null, [Query(Format = "yyyy-MM-dd")] DateTime? start = null, [Query(Format = "yyyy-MM-dd")] DateTime? end = null, TransactionTypeFilter? type = null);
