...
namespace FireflyIIINet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CurrencyExchangeProperties")]
    public partial class CurrencyExchangeProperties : IEquatable<CurrencyExchangeProperties>, IValidatableObject
    {
        /// <summary>
        ...
        [DataMember(Name = "from_currency_name", EmitDefaultValue = true)]
        [JsonPropertyName("from_currency_name")]
        [JsonInclude]
        public string FromCurrencyName { get; private set; }

        /// <summary>
        /// Returns false as FromCurrencyName should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeFromCurrencyName()
        {
            return false;
        }
        /// <summary>
        ...
        /// <example>EUR</example>
        [DataMember(Name = "to_currency_name", EmitDefaultValue = true)]
        [JsonPropertyName("to_currency_name")]
        [JsonInclude]
        public string ToCurrencyName { get; private set; }

        /// <summary>
        /// Returns false as ToCurrencyName should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeToCurrencyName()
        {
            return false;
        }
        /// <summary>
        ...
        {
            return Equals(input as CurrencyExchangeProperties);
        }

        /// <summary>
        /// Returns true if CurrencyExchangeProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of CurrencyExchangeProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurrencyExchangeProperties input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    FromCurrencyName == input.FromCurrencyName ||
					FromCurrencyName.Equals(input.FromCurrencyName)
                ) &&
                (
                ...
                (
                    ToCurrencyName == input.ToCurrencyName ||
					ToCurrencyName.Equals(input.ToCurrencyName)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
				...
				hashCode = (hashCode * 59) + FromCurrencyName.GetHashCode();
				...
				hashCode = (hashCode * 59) + ToCurrencyName.GetHashCode();
