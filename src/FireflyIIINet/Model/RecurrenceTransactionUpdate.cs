...
namespace FireflyIIINet.Model
{
    ...
    public partial class RecurrenceTransactionUpdate : IEquatable<RecurrenceTransactionUpdate>, IValidatableObject
    {
        ...
        /// <param name="id">ID of the recurring transaction. Not to be confused with the ID of the recurrence itself. Is marked as REQUIRED but can be skipped when there is only ONE transaction..</param>
