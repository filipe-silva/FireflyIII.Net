...
namespace FireflyIIINet.Model
{
    ...
    public partial class AutocompleteCurrencyCode : IEquatable<AutocompleteCurrencyCode>, IValidatableObject
    {
        ...
        /// <param name="name">CurrencyProperties name with the code between brackets. (required).</param>
        /// <param name="code">CurrencyProperties code. (required).</param>
        ...
        /// <summary>
        /// CurrencyProperties name with the code between brackets.
        /// </summary>
        /// <value>CurrencyProperties name with the code between brackets.</value>
        /// <example>CurrencyProperties name (XCN)</example>
        [DataMember(Name = "name", IsRequired = true, EmitDefaultValue = true)]
        [JsonPropertyName("name")]
        public string Name { get; set; }

        /// <summary>
        /// CurrencyProperties code.
        /// </summary>
        /// <value>CurrencyProperties code.</value>
        /// <example>EUR</example>
