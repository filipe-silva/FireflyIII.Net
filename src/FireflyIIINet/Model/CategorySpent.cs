...
namespace FireflyIIINet.Model
{
    ...
    public partial class CategorySpent : IEquatable<CategorySpent>, IValidatableObject
    {
        ...
        public CategorySpent(string currencyId = default(string), string currencyCode = default(string), string currencySymbol = default(string), int currencyDecimalPlaces = default(int), string sum = default(string))
        {
        ...
        {
            return Equals(input as CategorySpent);
        }
