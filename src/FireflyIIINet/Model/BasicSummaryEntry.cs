...
namespace FireflyIIINet.Model
{
    ...
    public partial class BasicSummaryEntry : IEquatable<BasicSummaryEntry>, IValidatableObject
    {
        ...
        [DataMember(Name = "no_available_budgets", EmitDefaultValue = true)]
        [JsonPropertyName("no_available_budgets")]
        public bool NoAvailableBudgets { get; set; }
        ...
        public bool Equals(BasicSummaryEntry input)
        {
            ...
            return 
                ...
                (
                    NoAvailableBudgets == input.NoAvailableBudgets ||
                    NoAvailableBudgets.Equals(input.NoAvailableBudgets)
                ) &&
                (
