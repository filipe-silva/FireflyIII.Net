...
namespace FireflyIIINet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionV2SplitStore")]
    public partial class TransactionV2SplitStore : IEquatable<TransactionV2SplitStore>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionV2SplitStore" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionV2SplitStore() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionV2SplitStore" /> class.
        /// </summary>
        ...
        public TransactionV2SplitStore(TransactionTypeProperty type = default(TransactionTypeProperty), DateTime? date = default(DateTime?), string amount = default(string), string description = default(string), int? order = default(int?), string currencyId = default(string), string currencyCode = default(string), string foreignAmount = default(string), string foreignCurrencyId = default(string), string foreignCurrencyCode = default(string), string budgetId = default(string), string categoryId = default(string), string categoryName = default(string), string sourceId = default(string), string sourceName = default(string), string destinationId = default(string), string destinationName = default(string), bool reconciled = default(bool), int? piggyBankId = default(int?), string piggyBankName = default(string), string billId = default(string), string billName = default(string), List<string> tags = default(List<string>), string notes = default(string), string internalReference = default(string), string externalId = default(string), string externalUrl = default(string), string bunqPaymentId = default(string), string sepaCc = default(string), string sepaCtOp = default(string), string sepaCtId = default(string), string sepaDb = default(string), string sepaCountry = default(string), string sepaEp = default(string), string sepaCi = default(string), string sepaBatchId = default(string), DateTime? interestDate = default(DateTime?), DateTime? bookDate = default(DateTime?), DateTime? processDate = default(DateTime?), DateTime? dueDate = default(DateTime?), DateTime? paymentDate = default(DateTime?), DateTime? invoiceDate = default(DateTime?))
        {
            ...
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for TransactionV2SplitStore and cannot be null");
            }
            Amount = amount;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for TransactionV2SplitStore and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionV2SplitStore {\n");
        ...
        {
            return Equals(input as TransactionV2SplitStore);
        }

        /// <summary>
        /// Returns true if TransactionV2SplitStore instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionV2SplitStore to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionV2SplitStore input)
        {
            if (input == null)
            {
                return false;
