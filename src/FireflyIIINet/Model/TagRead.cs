...
namespace FireflyIIINet.Model
{
    ...
    public partial class TagRead : IEquatable<TagRead>, IValidatableObject
    {
        ...
        public TagRead(string type = default(string), string id = default(string), TagModel attributes = default(TagModel), ObjectLink links = default(ObjectLink))
        {
