...
namespace FireflyIIINet.Model
{
    ...
    public partial class AccountUpdate : IEquatable<AccountUpdate>, IValidatableObject
    {
        ...
        public AccountUpdate(string name = default(string), string iban = default(string), string bic = default(string), string accountNumber = default(string), string openingBalance = default(string), DateTime? openingBalanceDate = default(DateTime?), string virtualBalance = default(string), string currencyId = default(string), string currencyCode = default(string), bool active = true, int order = default(int), bool includeNetWorth = true, AccountRoleProperty? accountRole = default(AccountRoleProperty?), CreditCardType? creditCardType = default(CreditCardType?), DateTime? monthlyPaymentDate = default(DateTime?), LiabilityType? liabilityType = default(LiabilityType?), string interest = default(string), InterestPeriod? interestPeriod = default(InterestPeriod?), string notes = default(string), double? latitude = default(double?), double? longitude = default(double?), int? zoomLevel = default(int?))
        {
