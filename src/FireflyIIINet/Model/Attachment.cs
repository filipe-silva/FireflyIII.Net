...
namespace FireflyIIINet.Model
{
    ...
    public partial class Attachment : IEquatable<Attachment>, IValidatableObject
    {
        ...
        public Attachment(AttachableType attachableType = default(AttachableType), string attachableId = default(string), string md5 = default(string), string filename = default(string), string downloadUrl = default(string), string uploadUrl = default(string), string title = default(string), string notes = default(string), string hash = default(string))
        {
