...
namespace FireflyIIINet.Model
{
    ...
    public partial class AvailableBudgetRead : IEquatable<AvailableBudgetRead>, IValidatableObject
    {
        ...
        public AvailableBudgetRead(string type = default(string), string id = default(string), AvailableBudgetProperties attributes = default(AvailableBudgetProperties))
        {
        ...
        public AvailableBudgetProperties Attributes { get; set; }
        ...
        {
            return Equals(input as AvailableBudgetRead);
        }
