...
namespace FireflyIIINet.Model
{
    ...
    public partial class BudgetRead : IEquatable<BudgetRead>, IValidatableObject
    {
        ...
        public BudgetRead(string type = default(string), string id = default(string), BudgetProperties attributes = default(BudgetProperties))
        {
        ...
        public BudgetProperties Attributes { get; set; }
