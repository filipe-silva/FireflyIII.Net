...
namespace FireflyIIINet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ArrayEntryWithCurrencyAndSum")]
    public partial class ArrayEntryWithCurrencyAndSum : IEquatable<ArrayEntryWithCurrencyAndSum>, IValidatableObject
    {
        /// <summary>
        ...
        public ArrayEntryWithCurrencyAndSum(string currencyId = default(string), string currencyCode = default(string), string currencySymbol = default(string), int currencyDecimalPlaces = default(int), string sum = default(string))
        {
        ...
        {
            return Equals(input as ArrayEntryWithCurrencyAndSum);
        }

        /// <summary>
        /// Returns true if ArrayEntryWithCurrencyAndSum instances are equal
        /// </summary>
        /// <param name="input">Instance of ArrayEntryWithCurrencyAndSum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArrayEntryWithCurrencyAndSum input)
        {
            if (input == null)
            {
                return false;
