...
namespace FireflyIIINet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AutocompleteAccountV2")]
    public partial class AutocompleteAccountV2 : IEquatable<AutocompleteAccountV2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutocompleteAccountV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AutocompleteAccountV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AutocompleteAccountV2" /> class.
        /// </summary>
        ...
        public AutocompleteAccountV2(string id = default(string), string name = default(string), string nameWithBalance = default(string), string type = default(string), string currencyId = default(string), string currencyName = default(string), string currencyCode = default(string), string currencySymbol = default(string), int currencyDecimalPlaces = default(int))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for AutocompleteAccountV2 and cannot be null");
            }
            Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AutocompleteAccountV2 and cannot be null");
            }
            Name = name;
            // to ensure "nameWithBalance" is required (not null)
            if (nameWithBalance == null)
            {
                throw new ArgumentNullException("nameWithBalance is a required property for AutocompleteAccountV2 and cannot be null");
            }
            NameWithBalance = nameWithBalance;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for AutocompleteAccountV2 and cannot be null");
            }
            Type = type;
            // to ensure "currencyId" is required (not null)
            if (currencyId == null)
            {
                throw new ArgumentNullException("currencyId is a required property for AutocompleteAccountV2 and cannot be null");
            }
            CurrencyId = currencyId;
            // to ensure "currencyName" is required (not null)
            if (currencyName == null)
            {
                throw new ArgumentNullException("currencyName is a required property for AutocompleteAccountV2 and cannot be null");
            }
            CurrencyName = currencyName;
            // to ensure "currencyCode" is required (not null)
            if (currencyCode == null)
            {
                throw new ArgumentNullException("currencyCode is a required property for AutocompleteAccountV2 and cannot be null");
            }
            CurrencyCode = currencyCode;
            // to ensure "currencySymbol" is required (not null)
            if (currencySymbol == null)
            {
                throw new ArgumentNullException("currencySymbol is a required property for AutocompleteAccountV2 and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AutocompleteAccountV2 {\n");
        ...
        {
            return Equals(input as AutocompleteAccountV2);
        }

        /// <summary>
        /// Returns true if AutocompleteAccountV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of AutocompleteAccountV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutocompleteAccountV2 input)
        {
            if (input == null)
            {
                return false;
