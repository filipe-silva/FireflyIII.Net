...
namespace FireflyIIINet.Model
{
    ...
    public partial class Bill : IEquatable<Bill>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The max amount of this bill in the user&#39;s native currency, if the original amount is in a different currency.</value>
        /// <example>123.45</example>
        [DataMember(Name = "native_amount_min", EmitDefaultValue = false)]
        [JsonPropertyName("native_amount_min")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        [JsonInclude]
        public string NativeAmountMin { get; private set; }

        /// <summary>
        /// Returns false as NativeAmountMin should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeNativeAmountMin()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>The min amount of this bill in the user&#39;s native currency, if the original amount is in a different currency.</value>
        /// <example>123.45</example>
        [DataMember(Name = "native_amount_max", EmitDefaultValue = false)]
        [JsonPropertyName("native_amount_max")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        [JsonInclude]
        public string NativeAmountMax { get; private set; }

        /// <summary>
        /// Returns false as NativeAmountMax should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeNativeAmountMax()
        {
            return false;
        }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NativeAmountMin: ").Append(NativeAmountMin).Append("\n");
            sb.Append("  NativeAmountMax: ").Append(NativeAmountMax).Append("\n");
        ...
        public bool Equals(Bill input)
        {
            ...
            return 
                ...
                (
                    NativeAmountMin == input.NativeAmountMin ||
                    (NativeAmountMin != null &&
                    NativeAmountMin.Equals(input.NativeAmountMin))
                ) && 
                (
                    NativeAmountMax == input.NativeAmountMax ||
                    (NativeAmountMax != null &&
                    NativeAmountMax.Equals(input.NativeAmountMax))
                ) && 
                (
                    Date == input.Date ||
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (NativeAmountMin != null)
                {
                    hashCode = (hashCode * 59) + NativeAmountMin.GetHashCode();
                }
                if (NativeAmountMax != null)
                {
                    hashCode = (hashCode * 59) + NativeAmountMax.GetHashCode();
                }
