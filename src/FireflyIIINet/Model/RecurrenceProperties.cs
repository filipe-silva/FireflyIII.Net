...
namespace FireflyIIINet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RecurrenceProperties")]
    public partial class RecurrenceProperties : IEquatable<RecurrenceProperties>, IValidatableObject
    {
        ...
        protected RecurrenceProperties() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RecurrenceProperties" /> class.
        /// </summary>
        ...
        {
            return Equals(input as RecurrenceProperties);
        }

        /// <summary>
        /// Returns true if RecurrenceProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of RecurrenceProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecurrenceProperties input)
        {
            if (input == null)
            {
                return false;
