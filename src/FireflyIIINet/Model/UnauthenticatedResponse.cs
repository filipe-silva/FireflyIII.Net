...
namespace FireflyIIINet.Model
{
    ...
    public partial class UnauthenticatedResponse : IEquatable<UnauthenticatedResponse>, IValidatableObject
    {
        ...
        public UnauthenticatedResponse(string message = default(string), string exception = default(string))
        {
            Message = message;
            Exception = exception;
        }
        ...
        /// </summary>
        /// <example>UnauthenticatedResponse</example>
        ...
        {
            return Equals(input as UnauthenticatedResponse);
        }
