...
namespace FireflyIIINet.Model
{
    ...
    /// TransactionLinkRead
    /// </summary>
    [DataContract(Name = "TransactionLinkRead")]
    public partial class TransactionLinkRead : IEquatable<TransactionLinkRead>, IValidatableObject
    {
        ...
        public TransactionLinkRead(string type = default(string), string id = default(string), TransactionLink attributes = default(TransactionLink), ObjectLink links = default(ObjectLink))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for TransactionLinkRead and cannot be null");
            }
            Type = type;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for TransactionLinkRead and cannot be null");
            }
            Id = id;
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new ArgumentNullException("attributes is a required property for TransactionLinkRead and cannot be null");
            }
            Attributes = attributes;
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for TransactionLinkRead and cannot be null");
            }
            Links = links;
        }
        ...
        /// <example>transactionLinks</example>
        ...
        {
            return Equals(input as TransactionLinkRead);
        }
