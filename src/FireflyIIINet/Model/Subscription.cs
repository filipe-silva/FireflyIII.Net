...
namespace FireflyIIINet.Model
{
    ...
    public partial class Subscription : IEquatable<Subscription>, IValidatableObject
    {
        ...
        public SubscriptionRepeatProperty RepeatFreq { get; set; }
        /// <summary>
        ...
        /// <param name="nativeAmountMin">nativeAmountMin.</param>
        /// <param name="nativeAmountMax">nativeAmountMax.</param>
        ...
        /// <param name="nativeCurrencyId">nativeCurrencyId.</param>
        /// <param name="nativeCurrencyCode">nativeCurrencyCode.</param>
        ...
        public Subscription(string name = default(string), string amountMin = default(string), string amountMax = default(string), string nativeAmountMin = default(string), string nativeAmountMax = default(string), string currencyId = default(string), string currencyCode = default(string), string nativeCurrencyId = default(string), string nativeCurrencyCode = default(string), DateTime? date = default(DateTime?), DateTime? endDate = default(DateTime?), DateTime? extensionDate = default(DateTime?), SubscriptionRepeatProperty repeatFreq = default(SubscriptionRepeatProperty), int skip = default(int), bool active = default(bool), int order = default(int), string notes = default(string), string objectGroupId = default(string), string objectGroupTitle = default(string))
        {
            ...
            if (amountMin == null)
            {
                throw new ArgumentNullException("amountMin is a required property for Subscription and cannot be null");
            }
            AmountMin = amountMin;
            // to ensure "amountMax" is required (not null)
            if (amountMax == null)
            {
                throw new ArgumentNullException("amountMax is a required property for Subscription and cannot be null");
            }
            AmountMax = amountMax;
            Date = date ?? default(DateTime);
            RepeatFreq = repeatFreq;
            NativeAmountMin = nativeAmountMin;
            NativeAmountMax = nativeAmountMax;
        ...
        /// <summary>
        /// Gets or Sets NativeAmountMin
        /// </summary>
        /// <example>123.45</example>
        [DataMember(Name = "native_amount_min", EmitDefaultValue = true)]
        [JsonPropertyName("native_amount_min")]
        public string NativeAmountMin { get; set; }

        /// <summary>
        /// Gets or Sets NativeAmountMax
        /// </summary>
        /// <example>123.45</example>
        [DataMember(Name = "native_amount_max", EmitDefaultValue = true)]
        [JsonPropertyName("native_amount_max")]
        public string NativeAmountMax { get; set; }
