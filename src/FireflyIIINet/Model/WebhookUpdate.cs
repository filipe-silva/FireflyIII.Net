...
namespace FireflyIIINet.Model
{
    ...
    public partial class WebhookUpdate : IEquatable<WebhookUpdate>, IValidatableObject
    {
        ...
        public WebhookUpdate(bool active = default(bool), string title = default(string), string secret = default(string), WebhookTrigger? trigger = default(WebhookTrigger?), WebhookResponse? response = default(WebhookResponse?), WebhookDelivery? delivery = default(WebhookDelivery?), string url = default(string))
        {
            Active = active;
            Title = title;
            Secret = secret;
