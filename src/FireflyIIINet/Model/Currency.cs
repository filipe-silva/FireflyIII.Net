...
namespace FireflyIIINet.Model
{
    ...
    public partial class Currency : IEquatable<Currency>, IValidatableObject
    {
        ...
        /// <param name="native">Make this currency the native currency..</param>
        public Currency(bool enabled = true, bool varDefault = default(bool), string code = default(string), string name = default(string), string symbol = default(string), int decimalPlaces = default(int), bool native = default(bool))
        {
        ...
        /// </summary>
        /// <value>Make this currency the native currency.</value>
        /// <example>false</example>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + Native.GetHashCode();
