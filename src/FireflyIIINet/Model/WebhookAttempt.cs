...
namespace FireflyIIINet.Model
{
    ...
    public partial class WebhookAttempt : IEquatable<WebhookAttempt>, IValidatableObject
    {
        ...
        /// <param name="response">WebhookProperties receiver response for this attempt, if any. May contain sensitive user data..</param>
        ...
        /// <summary>
        /// WebhookProperties receiver response for this attempt, if any. May contain sensitive user data.
        /// </summary>
        /// <value>WebhookProperties receiver response for this attempt, if any. May contain sensitive user data.</value>
        /// <example>Page not found</example>
