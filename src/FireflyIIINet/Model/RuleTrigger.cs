...
namespace FireflyIIINet.Model
{
    ...
    public partial class RuleTrigger : IEquatable<RuleTrigger>, IValidatableObject
    {
        ...
        public RuleTrigger(RuleTriggerKeyword type = default(RuleTriggerKeyword), string value = default(string), bool active = true, bool stopProcessing = false, bool prohibited = false)
        {
            Type = type;
