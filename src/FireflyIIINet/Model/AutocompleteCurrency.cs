...
namespace FireflyIIINet.Model
{
    ...
    public partial class AutocompleteCurrency : IEquatable<AutocompleteCurrency>, IValidatableObject
    {
        ...
        /// <param name="name">CurrencyProperties name. (required).</param>
        ...
        /// <summary>
        /// CurrencyProperties name.
        /// </summary>
        /// <value>CurrencyProperties name.</value>
        /// <example>CurrencyProperties name</example>
        ...
        {
            return Equals(input as AutocompleteCurrency);
        }
