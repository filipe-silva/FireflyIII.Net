...
namespace FireflyIIINet.Model
{
    ...
    public partial class RuleTriggerStore : IEquatable<RuleTriggerStore>, IValidatableObject
    {
        ...
        public RuleTriggerStore(RuleTriggerKeyword type = default(RuleTriggerKeyword), string value = default(string), int order = default(int), bool active = true, bool stopProcessing = false, bool prohibited = false)
        {
            Type = type;
        ...
        public bool Equals(RuleTriggerStore input)
        {
            ...
            return 
                ...
                (
                    ...
                    Prohibited.Equals(input.Prohibited)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + Prohibited.GetHashCode();
                return hashCode;
            }
        }
