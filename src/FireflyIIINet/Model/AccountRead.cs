...
namespace FireflyIIINet.Model
{
    ...
    public partial class AccountRead : IEquatable<AccountRead>, IValidatableObject
    {
        ...
        public AccountRead(string type = default(string), string id = default(string), AccountProperties attributes = default(AccountProperties))
        {
        ...
        public AccountProperties Attributes { get; set; }
