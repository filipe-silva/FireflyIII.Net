...
namespace FireflyIIINet.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/2.0.2.1/csharp");
        ...
        public Configuration(
            ...
            string basePath = "https://demo.firefly-iii.org/api") : this()
        {
        ...
        {
            string report = "C# SDK (FireflyIIINet) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2.0.2\n";
            report += "    SDK Package Version: 2.0.2.1\n";
