...
# **GetBasicSummary**
> List&lt;BasicSummaryEntry&gt; GetBasicSummary (DateTime start, DateTime end, Guid? xTraceId = null, string? currencyCode = null)
...
namespace Example
{
    public class GetBasicSummaryExample
    {
        public static void Main()
        {
            ...
            {
                // Returns basic sums of the users data.
                List<BasicSummaryEntry> result = apiInstance.GetBasicSummary(start, end, xTraceId, currencyCode);
...
{
    // Returns basic sums of the users data.
    ApiResponse<List<BasicSummaryEntry>> response = apiInstance.GetBasicSummaryWithHttpInfo(start, end, xTraceId, currencyCode);
