...
namespace FireflyIIINet.Test.Api
{
    ...
    public class InsightApiTests : IDisposable
    {
        ...
        public void InsightExpenseAssetTest()
        {
            ...
            //var response = instance.InsightExpenseAsset(start, end, accounts);
        ...
        public void InsightExpenseBillTest()
        {
            ...
            //List<long> accounts = null;
            //var response = instance.InsightExpenseBill(start, end, bills, accounts);
            //Assert.IsType<List<InsightGroupEntry>>(response);
        }
        ...
        public void InsightExpenseBudgetTest()
        {
            ...
            //List<long> accounts = null;
            //var response = instance.InsightExpenseBudget(start, end, budgets, accounts);
            //Assert.IsType<List<InsightGroupEntry>>(response);
        }
        ...
        public void InsightExpenseCategoryTest()
        {
            ...
            //List<long> accounts = null;
            //var response = instance.InsightExpenseCategory(start, end, categories, accounts);
            //Assert.IsType<List<InsightGroupEntry>>(response);
        }
        ...
        public void InsightExpenseExpenseTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightExpenseExpense(start, end, accounts);
            //Assert.IsType<List<InsightGroupEntry>>(response);
        }
        ...
        public void InsightExpenseNoBillTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightExpenseNoBill(start, end, accounts);
        ...
        public void InsightExpenseNoBudgetTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightExpenseNoBudget(start, end, accounts);
            //Assert.IsType<List<InsightTotalEntry>>(response);
        }
        ...
        public void InsightExpenseNoCategoryTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightExpenseNoCategory(start, end, accounts);
            //Assert.IsType<List<InsightTotalEntry>>(response);
        }
        ...
        public void InsightExpenseNoTagTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightExpenseNoTag(start, end, accounts);
            //Assert.IsType<List<InsightTotalEntry>>(response);
        }
        ...
        public void InsightExpenseTagTest()
        {
            ...
            //List<long> tags = null;
            //List<long> accounts = null;
            //var response = instance.InsightExpenseTag(start, end, tags, accounts);
            //Assert.IsType<List<InsightGroupEntry>>(response);
        }
        ...
        public void InsightExpenseTotalTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightExpenseTotal(start, end, accounts);
            //Assert.IsType<List<InsightTotalEntry>>(response);
        }
        ...
        public void InsightIncomeAssetTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightIncomeAsset(start, end, accounts);
            //Assert.IsType<List<InsightGroupEntry>>(response);
        }
        ...
        public void InsightIncomeCategoryTest()
        {
            ...
            //List<long> categories = null;
            //List<long> accounts = null;
            //var response = instance.InsightIncomeCategory(start, end, categories, accounts);
            //Assert.IsType<List<InsightGroupEntry>>(response);
        }
        ...
        public void InsightIncomeNoCategoryTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightIncomeNoCategory(start, end, accounts);
            //Assert.IsType<List<InsightTotalEntry>>(response);
        }
        ...
        public void InsightIncomeNoTagTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightIncomeNoTag(start, end, accounts);
            //Assert.IsType<List<InsightTotalEntry>>(response);
        }
        ...
        public void InsightIncomeRevenueTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightIncomeRevenue(start, end, accounts);
            //Assert.IsType<List<InsightGroupEntry>>(response);
        }
        ...
        public void InsightIncomeTagTest()
        {
            ...
            //List<long> tags = null;
            //List<long> accounts = null;
            //var response = instance.InsightIncomeTag(start, end, tags, accounts);
            //Assert.IsType<List<InsightGroupEntry>>(response);
        }
        ...
        public void InsightIncomeTotalTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightIncomeTotal(start, end, accounts);
            //Assert.IsType<List<InsightTotalEntry>>(response);
        }
        ...
        public void InsightTransferCategoryTest()
        {
            ...
            //List<long> categories = null;
            //List<long> accounts = null;
            //var response = instance.InsightTransferCategory(start, end, categories, accounts);
            //Assert.IsType<List<InsightGroupEntry>>(response);
        }
        ...
        public void InsightTransferNoCategoryTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightTransferNoCategory(start, end, accounts);
            //Assert.IsType<List<InsightTotalEntry>>(response);
        }
        ...
        public void InsightTransferNoTagTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightTransferNoTag(start, end, accounts);
            //Assert.IsType<List<InsightTotalEntry>>(response);
        }
        ...
        public void InsightTransferTagTest()
        {
            ...
            //List<long> tags = null;
            //List<long> accounts = null;
            //var response = instance.InsightTransferTag(start, end, tags, accounts);
            //Assert.IsType<List<InsightGroupEntry>>(response);
        }
        ...
        public void InsightTransferTotalTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightTransferTotal(start, end, accounts);
            //Assert.IsType<List<InsightTotalEntry>>(response);
        }
        ...
        public void InsightTransfersTest()
        {
            ...
            //DateTime end = null;
            //List<long> accounts = null;
            //var response = instance.InsightTransfers(start, end, accounts);
            //Assert.IsType<List<InsightGroupEntry>>(response);
        }
    }
}
