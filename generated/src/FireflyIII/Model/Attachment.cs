...
namespace FireflyIII.Model
{
    ...
    public partial class Attachment : IEquatable<Attachment>, IValidatableObject
    {
        ...
        /// <summary>
        /// Returns false as AttachableType should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeAttachableType()
        {
            return false;
        }
        /// <summary>
        ...
        /// <summary>
        /// Returns false as AttachableId should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeAttachableId()
        {
            return false;
        }
        /// <summary>
        ...
        /// <value>ID of the model this attachment is linked to.</value>
        /// <example>134</example>
        [DataMember(Name = "model_id", IsRequired = true, EmitDefaultValue = true)]
