...
namespace FireflyIII.Api
{
    ...
    public partial class ConfigurationApi : IConfigurationApi
    {
        ...
        {
            FireflyIII.Client.ApiResponse<ModelConfiguration> localVarResponse = GetConfigurationWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ModelConfiguration</returns>
        public FireflyIII.Client.ApiResponse<ModelConfiguration> GetConfigurationWithHttpInfo(int operationIndex = 0)
        {
        ...
        {
            FireflyIII.Client.ApiResponse<ModelConfiguration> localVarResponse = await GetConfigurationWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ModelConfiguration)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<ModelConfiguration>> GetConfigurationWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            FireflyIII.Client.ApiResponse<ModelConfiguration> localVarResponse = SetConfigurationWithHttpInfo(name, value);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ModelConfiguration</returns>
        public FireflyIII.Client.ApiResponse<ModelConfiguration> SetConfigurationWithHttpInfo(string name, string value, int operationIndex = 0)
        {
        ...
        {
            FireflyIII.Client.ApiResponse<ModelConfiguration> localVarResponse = await SetConfigurationWithHttpInfoAsync(name, value, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ModelConfiguration)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<ModelConfiguration>> SetConfigurationWithHttpInfoAsync(string name, string value, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
            {
