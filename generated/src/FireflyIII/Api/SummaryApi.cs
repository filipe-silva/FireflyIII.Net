...
namespace FireflyIII.Api
{
    ...
    public partial class SummaryApi : ISummaryApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;BasicSummaryEntry&gt;</returns>
        public FireflyIII.Client.ApiResponse<List<BasicSummaryEntry>> GetBasicSummaryWithHttpInfo(DateTime start, DateTime end, string currencyCode = default(string), int operationIndex = 0)
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(FireflyIII.Client.ClientUtils.ParameterToMultiMap("", "currency_code", currencyCode));
            }
        ...
        {
            FireflyIII.Client.ApiResponse<List<BasicSummaryEntry>> localVarResponse = await GetBasicSummaryWithHttpInfoAsync(start, end, currencyCode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;BasicSummaryEntry&gt;)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<List<BasicSummaryEntry>>> GetBasicSummaryWithHttpInfoAsync(DateTime start, DateTime end, string currencyCode = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
