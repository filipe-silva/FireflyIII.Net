...
namespace FireflyIII.Api
{
    ...
    public partial class PreferencesApi : IPreferencesApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PreferenceSingle</returns>
        public FireflyIII.Client.ApiResponse<PreferenceSingle> GetPreferenceWithHttpInfo(string name, int operationIndex = 0)
        {
        ...
        {
            FireflyIII.Client.ApiResponse<PreferenceSingle> localVarResponse = await GetPreferenceWithHttpInfoAsync(name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PreferenceSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<PreferenceSingle>> GetPreferenceWithHttpInfoAsync(string name, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PreferenceArray</returns>
        public FireflyIII.Client.ApiResponse<PreferenceArray> ListPreferenceWithHttpInfo(int? page = default(int?), int operationIndex = 0)
        {
            FireflyIII.Client.RequestOptions localVarRequestOptions = new FireflyIII.Client.RequestOptions();
        ...
        {
            FireflyIII.Client.ApiResponse<PreferenceArray> localVarResponse = await ListPreferenceWithHttpInfoAsync(page, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PreferenceArray)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<PreferenceArray>> ListPreferenceWithHttpInfoAsync(int? page = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PreferenceSingle</returns>
        public FireflyIII.Client.ApiResponse<PreferenceSingle> UpdatePreferenceWithHttpInfo(string name, Preference preference, int operationIndex = 0)
        {
            // verify the required parameter 'name' is set
            if (name == null)
            {
        ...
        {
            FireflyIII.Client.ApiResponse<PreferenceSingle> localVarResponse = await UpdatePreferenceWithHttpInfoAsync(name, preference, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PreferenceSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIII.Client.ApiResponse<PreferenceSingle>> UpdatePreferenceWithHttpInfoAsync(string name, Preference preference, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
            {
