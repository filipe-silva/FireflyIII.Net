...
namespace FireflyIIINet.Api
{
    ...
    public partial class AttachmentsApi : IAttachmentsApi
    {
        ...
        {
            FireflyIIINet.Client.ApiResponse<AttachmentSingle> localVarResponse = StoreAttachmentWithHttpInfo(attachment);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AttachmentSingle</returns>
        public FireflyIIINet.Client.ApiResponse<AttachmentSingle> StoreAttachmentWithHttpInfo(Attachment attachment, int operationIndex = 0)
        {
            // verify the required parameter 'attachment' is set
            if (attachment == null)
            {
                throw new FireflyIIINet.Client.ApiException(400, "Missing required parameter 'attachment' when calling AttachmentsApi->StoreAttachment");
            }
        ...
        {
            FireflyIIINet.Client.ApiResponse<AttachmentSingle> localVarResponse = await StoreAttachmentWithHttpInfoAsync(attachment, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AttachmentSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIIINet.Client.ApiResponse<AttachmentSingle>> StoreAttachmentWithHttpInfoAsync(Attachment attachment, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'attachment' is set
            if (attachment == null)
            {
        ...
        {
            FireflyIIINet.Client.ApiResponse<AttachmentSingle> localVarResponse = UpdateAttachmentWithHttpInfo(id, attachment);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AttachmentSingle</returns>
        public FireflyIIINet.Client.ApiResponse<AttachmentSingle> UpdateAttachmentWithHttpInfo(int id, Attachment attachment, int operationIndex = 0)
        {
            // verify the required parameter 'attachment' is set
            if (attachment == null)
            {
                throw new FireflyIIINet.Client.ApiException(400, "Missing required parameter 'attachment' when calling AttachmentsApi->UpdateAttachment");
            }
        ...
        {
            FireflyIIINet.Client.ApiResponse<AttachmentSingle> localVarResponse = await UpdateAttachmentWithHttpInfoAsync(id, attachment, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AttachmentSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIIINet.Client.ApiResponse<AttachmentSingle>> UpdateAttachmentWithHttpInfoAsync(int id, Attachment attachment, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'attachment' is set
            if (attachment == null)
            {
