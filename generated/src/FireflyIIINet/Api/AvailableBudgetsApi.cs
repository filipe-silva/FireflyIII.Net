...
namespace FireflyIIINet.Api
{
    ...
    public partial class AvailableBudgetsApi : IAvailableBudgetsApi
    {
        ...
        {
            FireflyIIINet.Client.ApiResponse<AvailableBudgetSingle> localVarResponse = StoreAvailableBudgetWithHttpInfo(availableBudget);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AvailableBudgetSingle</returns>
        public FireflyIIINet.Client.ApiResponse<AvailableBudgetSingle> StoreAvailableBudgetWithHttpInfo(AvailableBudget availableBudget, int operationIndex = 0)
        {
            // verify the required parameter 'availableBudget' is set
            if (availableBudget == null)
            {
                throw new FireflyIIINet.Client.ApiException(400, "Missing required parameter 'availableBudget' when calling AvailableBudgetsApi->StoreAvailableBudget");
            }
        ...
        {
            FireflyIIINet.Client.ApiResponse<AvailableBudgetSingle> localVarResponse = await StoreAvailableBudgetWithHttpInfoAsync(availableBudget, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AvailableBudgetSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIIINet.Client.ApiResponse<AvailableBudgetSingle>> StoreAvailableBudgetWithHttpInfoAsync(AvailableBudget availableBudget, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'availableBudget' is set
            if (availableBudget == null)
            {
        ...
        {
            FireflyIIINet.Client.ApiResponse<AvailableBudgetSingle> localVarResponse = UpdateAvailableBudgetWithHttpInfo(id, availableBudget);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AvailableBudgetSingle</returns>
        public FireflyIIINet.Client.ApiResponse<AvailableBudgetSingle> UpdateAvailableBudgetWithHttpInfo(int id, AvailableBudget availableBudget, int operationIndex = 0)
        {
            // verify the required parameter 'availableBudget' is set
            if (availableBudget == null)
            {
                throw new FireflyIIINet.Client.ApiException(400, "Missing required parameter 'availableBudget' when calling AvailableBudgetsApi->UpdateAvailableBudget");
            }
        ...
        {
            FireflyIIINet.Client.ApiResponse<AvailableBudgetSingle> localVarResponse = await UpdateAvailableBudgetWithHttpInfoAsync(id, availableBudget, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AvailableBudgetSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIIINet.Client.ApiResponse<AvailableBudgetSingle>> UpdateAvailableBudgetWithHttpInfoAsync(int id, AvailableBudget availableBudget, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'availableBudget' is set
            if (availableBudget == null)
            {
