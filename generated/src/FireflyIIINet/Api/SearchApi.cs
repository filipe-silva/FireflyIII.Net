...
namespace FireflyIIINet.Api
{
    ...
    public interface ISearchApiSync : IApiAccessor
    {
        ...
        AccountArray SearchAccounts(string query, AccountSearchFieldFilter field, int? page = default(int?), AccountTypeFilter type = default(AccountTypeFilter), int operationIndex = 0);
        ...
        ApiResponse<AccountArray> SearchAccountsWithHttpInfo(string query, AccountSearchFieldFilter field, int? page = default(int?), AccountTypeFilter type = default(AccountTypeFilter), int operationIndex = 0);
        /// <summary>
    ...
    public interface ISearchApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<AccountArray> SearchAccountsAsync(string query, AccountSearchFieldFilter field, int? page = default(int?), AccountTypeFilter type = default(AccountTypeFilter), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<AccountArray>> SearchAccountsWithHttpInfoAsync(string query, AccountSearchFieldFilter field, int? page = default(int?), AccountTypeFilter type = default(AccountTypeFilter), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Search for transactions
        /// </summary>
        /// <remarks>
    ...
    public partial class SearchApi : ISearchApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AccountArray</returns>
        public AccountArray SearchAccounts(string query, AccountSearchFieldFilter field, int? page = default(int?), AccountTypeFilter type = default(AccountTypeFilter), int operationIndex = 0)
        {
            FireflyIIINet.Client.ApiResponse<AccountArray> localVarResponse = SearchAccountsWithHttpInfo(query, field, page, type);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AccountArray</returns>
        public FireflyIIINet.Client.ApiResponse<AccountArray> SearchAccountsWithHttpInfo(string query, AccountSearchFieldFilter field, int? page = default(int?), AccountTypeFilter type = default(AccountTypeFilter), int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AccountArray</returns>
        public async System.Threading.Tasks.Task<AccountArray> SearchAccountsAsync(string query, AccountSearchFieldFilter field, int? page = default(int?), AccountTypeFilter type = default(AccountTypeFilter), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FireflyIIINet.Client.ApiResponse<AccountArray> localVarResponse = await SearchAccountsWithHttpInfoAsync(query, field, page, type, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountArray)</returns>
        public async System.Threading.Tasks.Task<FireflyIIINet.Client.ApiResponse<AccountArray>> SearchAccountsWithHttpInfoAsync(string query, AccountSearchFieldFilter field, int? page = default(int?), AccountTypeFilter type = default(AccountTypeFilter), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'query' is set
            if (query == null)
            {
