...
namespace FireflyIIINet.Api
{
    ...
    public interface ISummaryApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<BasicSummaryEntry>> GetBasicSummaryAsync(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), string? currencyCode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<BasicSummaryEntry>>> GetBasicSummaryWithHttpInfoAsync(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), string? currencyCode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class SummaryApi : ISummaryApi
    {
        ...
        {
            FireflyIIINet.Client.ApiResponse<List<BasicSummaryEntry>> localVarResponse = GetBasicSummaryWithHttpInfo(start, end, xTraceId, currencyCode);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;BasicSummaryEntry&gt;</returns>
        public FireflyIIINet.Client.ApiResponse<List<BasicSummaryEntry>> GetBasicSummaryWithHttpInfo(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), string? currencyCode = default(string?), int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<List<BasicSummaryEntry>>("/v1/summary/basic", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;BasicSummaryEntry&gt;</returns>
        public async System.Threading.Tasks.Task<List<BasicSummaryEntry>> GetBasicSummaryAsync(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), string? currencyCode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FireflyIIINet.Client.ApiResponse<List<BasicSummaryEntry>> localVarResponse = await GetBasicSummaryWithHttpInfoAsync(start, end, xTraceId, currencyCode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;BasicSummaryEntry&gt;)</returns>
        public async System.Threading.Tasks.Task<FireflyIIINet.Client.ApiResponse<List<BasicSummaryEntry>>> GetBasicSummaryWithHttpInfoAsync(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), string? currencyCode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<BasicSummaryEntry>>("/v1/summary/basic", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
