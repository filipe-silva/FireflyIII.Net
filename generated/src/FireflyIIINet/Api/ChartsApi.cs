...
namespace FireflyIIINet.Api
{
    ...
    public interface IChartsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<ChartDataSet>> GetChartAccountOverviewAsync(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<ChartDataSet>>> GetChartAccountOverviewWithHttpInfoAsync(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Dashboard chart with asset account balance information.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<ChartDataSetV2>> GetChartAccountOverviewV2Async(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<ChartDataSetV2>>> GetChartAccountOverviewV2WithHttpInfoAsync(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ChartsApi : IChartsApi
    {
        ...
        {
            FireflyIIINet.Client.ApiResponse<List<ChartDataSet>> localVarResponse = GetChartAccountOverviewWithHttpInfo(start, end, xTraceId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;ChartDataSet&gt;</returns>
        public FireflyIIINet.Client.ApiResponse<List<ChartDataSet>> GetChartAccountOverviewWithHttpInfo(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<List<ChartDataSet>>("/v1/chart/account/overview", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;ChartDataSet&gt;</returns>
        public async System.Threading.Tasks.Task<List<ChartDataSet>> GetChartAccountOverviewAsync(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FireflyIIINet.Client.ApiResponse<List<ChartDataSet>> localVarResponse = await GetChartAccountOverviewWithHttpInfoAsync(start, end, xTraceId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ChartDataSet&gt;)</returns>
        public async System.Threading.Tasks.Task<FireflyIIINet.Client.ApiResponse<List<ChartDataSet>>> GetChartAccountOverviewWithHttpInfoAsync(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<ChartDataSet>>("/v1/chart/account/overview", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            FireflyIIINet.Client.ApiResponse<List<ChartDataSetV2>> localVarResponse = GetChartAccountOverviewV2WithHttpInfo(start, end, xTraceId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;ChartDataSetV2&gt;</returns>
        public FireflyIIINet.Client.ApiResponse<List<ChartDataSetV2>> GetChartAccountOverviewV2WithHttpInfo(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), int operationIndex = 0)
        {
            FireflyIIINet.Client.RequestOptions localVarRequestOptions = new FireflyIIINet.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "ChartsApi.GetChartAccountOverviewV2";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetChartAccountOverviewV2", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;ChartDataSetV2&gt;</returns>
        public async System.Threading.Tasks.Task<List<ChartDataSetV2>> GetChartAccountOverviewV2Async(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FireflyIIINet.Client.ApiResponse<List<ChartDataSetV2>> localVarResponse = await GetChartAccountOverviewV2WithHttpInfoAsync(start, end, xTraceId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ChartDataSetV2&gt;)</returns>
        public async System.Threading.Tasks.Task<FireflyIIINet.Client.ApiResponse<List<ChartDataSetV2>>> GetChartAccountOverviewV2WithHttpInfoAsync(DateTime start, DateTime end, Guid? xTraceId = default(Guid?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
