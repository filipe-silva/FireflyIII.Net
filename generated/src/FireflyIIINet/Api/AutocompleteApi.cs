...
namespace FireflyIIINet.Api
{
    ...
    public interface IAutocompleteApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<AutocompleteAccount>> GetAccountsACAsync(Guid? xTraceId = default(Guid?), string? query = default(string?), int? limit = default(int?), string? date = default(string?), List<AccountTypeFilter>? types = default(List<AccountTypeFilter>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AutocompleteApi : IAutocompleteApi
    {
        ...
        {
            FireflyIIINet.Client.ApiResponse<List<AutocompleteAccount>> localVarResponse = GetAccountsACWithHttpInfo(xTraceId, query, limit, date, types);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;AutocompleteAccount&gt;</returns>
        public FireflyIIINet.Client.ApiResponse<List<AutocompleteAccount>> GetAccountsACWithHttpInfo(Guid? xTraceId = default(Guid?), string? query = default(string?), int? limit = default(int?), string? date = default(string?), List<AccountTypeFilter>? types = default(List<AccountTypeFilter>?), int operationIndex = 0)
        {
            ...
            if (types != null)
            {
                localVarRequestOptions.QueryParameters.Add(FireflyIIINet.Client.ClientUtils.ParameterToMultiMap("csv", "types", types));
            }
            if (xTraceId != null)
            {
        ...
        {
            FireflyIIINet.Client.ApiResponse<List<AutocompleteAccount>> localVarResponse = await GetAccountsACWithHttpInfoAsync(xTraceId, query, limit, date, types, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
