...
namespace FireflyIIINet.Api
{
    ...
    public interface IAutocompleteApiSync : IApiAccessor
    {
        ...
        List<AutocompleteAccount> GetAccountsAC(Guid? xTraceId = default(Guid?), string? query = default(string?), int? limit = default(int?), string? date = default(string?), List<AccountTypeFilter>? types = default(List<AccountTypeFilter>?), int operationIndex = 0);
        ...
        ApiResponse<List<AutocompleteAccount>> GetAccountsACWithHttpInfo(Guid? xTraceId = default(Guid?), string? query = default(string?), int? limit = default(int?), string? date = default(string?), List<AccountTypeFilter>? types = default(List<AccountTypeFilter>?), int operationIndex = 0);
        /// <summary>
    ...
    public interface IAutocompleteApiAsync : IApiAccessor
    {
        ...
        Task<List<AutocompleteAccount>> GetAccountsACAsync(Guid? xTraceId = default(Guid?), string? query = default(string?), int? limit = default(int?), string? date = default(string?), List<AccountTypeFilter>? types = default(List<AccountTypeFilter>?), int operationIndex = 0, CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ApiResponse<List<AutocompleteAccount>>> GetAccountsACWithHttpInfoAsync(Guid? xTraceId = default(Guid?), string? query = default(string?), int? limit = default(int?), string? date = default(string?), List<AccountTypeFilter>? types = default(List<AccountTypeFilter>?), int operationIndex = 0, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Returns all bills of the user returned in a basic auto-complete array.
        /// </summary>
        /// <remarks>
    ...
    public partial class AutocompleteApi : IAutocompleteApi
    {
        ...
        /// </summary>
		private RequestOptions GetRequestOptionsGetAccountsAC(Guid? xTraceId = default(Guid?), string? query = default(string?), int? limit = default(int?), string? date = default(string?), List<AccountTypeFilter>? types = default(List<AccountTypeFilter>?), int operationIndex = 0)
		{
            ...
            if (types != null)
            {
                localVarRequestOptions.QueryParameters.Add(ClientUtils.ParameterToMultiMap("csv", "types", types));
            }
            if (xTraceId != null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;AutocompleteAccount&gt;</returns>
        public List<AutocompleteAccount> GetAccountsAC(Guid? xTraceId = default(Guid?), string? query = default(string?), int? limit = default(int?), string? date = default(string?), List<AccountTypeFilter>? types = default(List<AccountTypeFilter>?), int operationIndex = 0)
        {
            ApiResponse<List<AutocompleteAccount>> localVarResponse = GetAccountsACWithHttpInfo(xTraceId, query, limit, date, types);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;AutocompleteAccount&gt;</returns>
        public ApiResponse<List<AutocompleteAccount>> GetAccountsACWithHttpInfo(Guid? xTraceId = default(Guid?), string? query = default(string?), int? limit = default(int?), string? date = default(string?), List<AccountTypeFilter>? types = default(List<AccountTypeFilter>?), int operationIndex = 0)
        {
            RequestOptions localVarRequestOptions = GetRequestOptionsGetAccountsAC(xTraceId, query, limit, date, types, operationIndex);
        ...
        {
            ApiResponse<List<AutocompleteAccount>> localVarResponse = await GetAccountsACWithHttpInfoAsync(xTraceId, query, limit, date, types, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
