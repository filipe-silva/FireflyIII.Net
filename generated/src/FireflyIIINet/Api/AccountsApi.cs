...
namespace FireflyIIINet.Api
{
    ...
    public partial class AccountsApi : IAccountsApi
    {
        ...
        {
            FireflyIIINet.Client.ApiResponse<AccountSingle> localVarResponse = StoreAccountWithHttpInfo(account);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AccountSingle</returns>
        public FireflyIIINet.Client.ApiResponse<AccountSingle> StoreAccountWithHttpInfo(Account account, int operationIndex = 0)
        {
            // verify the required parameter 'account' is set
            if (account == null)
            {
                throw new FireflyIIINet.Client.ApiException(400, "Missing required parameter 'account' when calling AccountsApi->StoreAccount");
            }
        ...
        {
            FireflyIIINet.Client.ApiResponse<AccountSingle> localVarResponse = await StoreAccountWithHttpInfoAsync(account, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIIINet.Client.ApiResponse<AccountSingle>> StoreAccountWithHttpInfoAsync(Account account, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'account' is set
            if (account == null)
            {
        ...
        {
            FireflyIIINet.Client.ApiResponse<AccountSingle> localVarResponse = UpdateAccountWithHttpInfo(id, account);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AccountSingle</returns>
        public FireflyIIINet.Client.ApiResponse<AccountSingle> UpdateAccountWithHttpInfo(int id, Account account, int operationIndex = 0)
        {
            // verify the required parameter 'account' is set
            if (account == null)
            {
                throw new FireflyIIINet.Client.ApiException(400, "Missing required parameter 'account' when calling AccountsApi->UpdateAccount");
            }
        ...
        {
            FireflyIIINet.Client.ApiResponse<AccountSingle> localVarResponse = await UpdateAccountWithHttpInfoAsync(id, account, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIIINet.Client.ApiResponse<AccountSingle>> UpdateAccountWithHttpInfoAsync(int id, Account account, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'account' is set
            if (account == null)
            {
