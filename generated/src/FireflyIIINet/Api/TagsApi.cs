...
namespace FireflyIIINet.Api
{
    ...
    public partial class TagsApi : ITagsApi
    {
        ...
        {
            FireflyIIINet.Client.ApiResponse<TagCloud> localVarResponse = GetTagCloudWithHttpInfo(start, end);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TagCloud</returns>
        public FireflyIIINet.Client.ApiResponse<TagCloud> GetTagCloudWithHttpInfo(DateTime start, DateTime end, int operationIndex = 0)
        {
            FireflyIIINet.Client.RequestOptions localVarRequestOptions = new FireflyIIINet.Client.RequestOptions();
        ...
        {
            FireflyIIINet.Client.ApiResponse<TagCloud> localVarResponse = await GetTagCloudWithHttpInfoAsync(start, end, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TagCloud)</returns>
        public async System.Threading.Tasks.Task<FireflyIIINet.Client.ApiResponse<TagCloud>> GetTagCloudWithHttpInfoAsync(DateTime start, DateTime end, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            FireflyIIINet.Client.ApiResponse<TagSingle> localVarResponse = StoreTagWithHttpInfo(tagModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TagSingle</returns>
        public FireflyIIINet.Client.ApiResponse<TagSingle> StoreTagWithHttpInfo(TagModel tagModel, int operationIndex = 0)
        {
            // verify the required parameter 'tagModel' is set
            if (tagModel == null)
            {
                throw new FireflyIIINet.Client.ApiException(400, "Missing required parameter 'tagModel' when calling TagsApi->StoreTag");
            }
        ...
        {
            FireflyIIINet.Client.ApiResponse<TagSingle> localVarResponse = await StoreTagWithHttpInfoAsync(tagModel, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TagSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIIINet.Client.ApiResponse<TagSingle>> StoreTagWithHttpInfoAsync(TagModel tagModel, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tagModel' is set
            if (tagModel == null)
            {
        ...
        {
            FireflyIIINet.Client.ApiResponse<TagSingle> localVarResponse = UpdateTagWithHttpInfo(tag, tagModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TagSingle</returns>
        public FireflyIIINet.Client.ApiResponse<TagSingle> UpdateTagWithHttpInfo(string tag, TagModel tagModel, int operationIndex = 0)
        {
            // verify the required parameter 'tag' is set
            if (tag == null)
            {
            ...
            if (tagModel == null)
            {
                throw new FireflyIIINet.Client.ApiException(400, "Missing required parameter 'tagModel' when calling TagsApi->UpdateTag");
            }
        ...
        {
            FireflyIIINet.Client.ApiResponse<TagSingle> localVarResponse = await UpdateTagWithHttpInfoAsync(tag, tagModel, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TagSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIIINet.Client.ApiResponse<TagSingle>> UpdateTagWithHttpInfoAsync(string tag, TagModel tagModel, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tag' is set
            if (tag == null)
            {
