...
namespace FireflyIIINet.Api
{
    ...
    public interface IRecurrencesApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RecurrenceSingle</returns>
        RecurrenceSingle UpdateRecurrence(int id, RecurrenceUpdate recurrenceUpdate, int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RecurrenceSingle</returns>
        ApiResponse<RecurrenceSingle> UpdateRecurrenceWithHttpInfo(int id, RecurrenceUpdate recurrenceUpdate, int operationIndex = 0);
    ...
    public interface IRecurrencesApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RecurrenceSingle</returns>
        System.Threading.Tasks.Task<RecurrenceSingle> UpdateRecurrenceAsync(int id, RecurrenceUpdate recurrenceUpdate, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RecurrenceSingle)</returns>
        System.Threading.Tasks.Task<ApiResponse<RecurrenceSingle>> UpdateRecurrenceWithHttpInfoAsync(int id, RecurrenceUpdate recurrenceUpdate, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class RecurrencesApi : IRecurrencesApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RecurrenceSingle</returns>
        public RecurrenceSingle UpdateRecurrence(int id, RecurrenceUpdate recurrenceUpdate, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RecurrenceSingle</returns>
        public FireflyIIINet.Client.ApiResponse<RecurrenceSingle> UpdateRecurrenceWithHttpInfo(int id, RecurrenceUpdate recurrenceUpdate, int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RecurrenceSingle</returns>
        public async System.Threading.Tasks.Task<RecurrenceSingle> UpdateRecurrenceAsync(int id, RecurrenceUpdate recurrenceUpdate, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RecurrenceSingle)</returns>
        public async System.Threading.Tasks.Task<FireflyIIINet.Client.ApiResponse<RecurrenceSingle>> UpdateRecurrenceWithHttpInfoAsync(int id, RecurrenceUpdate recurrenceUpdate, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'recurrenceUpdate' is set
            if (recurrenceUpdate == null)
            {
