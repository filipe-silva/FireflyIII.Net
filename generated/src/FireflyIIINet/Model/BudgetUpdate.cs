...
namespace FireflyIIINet.Model
{
    ...
    public partial class BudgetUpdate : IEquatable<BudgetUpdate>, IValidatableObject
    {
        ...
        public BudgetUpdate(string name = default(string), bool active = default(bool), int order = default(int), AutoBudgetType? autoBudgetType = default(AutoBudgetType?), string autoBudgetCurrencyId = default(string), string autoBudgetCurrencyCode = default(string), string autoBudgetAmount = default(string), AutoBudgetPeriod? autoBudgetPeriod = default(AutoBudgetPeriod?))
        {
            this.Name = name;
            this.Active = active;
            this.Order = order;
