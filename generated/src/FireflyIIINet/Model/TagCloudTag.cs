...
namespace FireflyIIINet.Model
{
    ...
    public partial class TagCloudTag : IEquatable<TagCloudTag>, IValidatableObject
    {
        ...
        public TagCloudTag(string tag = default(string), string id = default(string), double size = default(double), double relative = default(double))
        {
            this.Tag = tag;
            this.Id = id;
            this.Size = size;
