...
namespace FireflyIIINet.Model
{
    ...
    public partial class TransactionSplitUpdate : IEquatable<TransactionSplitUpdate>, IValidatableObject
    {
        ...
        public TransactionSplitUpdate(DateTime date = default(DateTime), string amount = default(string), string description = default(string), int? order = default(int?), int? currencyId = default(int?), string currencyCode = default(string), string foreignAmount = default(string), int? foreignCurrencyId = default(int?), string foreignCurrencyCode = default(string), int? budgetId = default(int?), int? categoryId = default(int?), string categoryName = default(string), int? sourceId = default(int?), string sourceName = default(string), string sourceIban = default(string), int? destinationId = default(int?), string destinationName = default(string), string destinationIban = default(string), bool reconciled = default(bool), int? billId = default(int?), string billName = default(string), List<string> tags = default(List<string>), string notes = default(string), string internalReference = default(string), string externalId = default(string), string bunqPaymentId = default(string), string sepaCc = default(string), string sepaCtOp = default(string), string sepaCtId = default(string), string sepaDb = default(string), string sepaCountry = default(string), string sepaEp = default(string), string sepaCi = default(string), string sepaBatchId = default(string), DateTime? interestDate = default(DateTime?), DateTime? bookDate = default(DateTime?), DateTime? processDate = default(DateTime?), DateTime? dueDate = default(DateTime?), DateTime? paymentDate = default(DateTime?), DateTime? invoiceDate = default(DateTime?))
        {
            this.Date = date;
            this.Amount = amount;
