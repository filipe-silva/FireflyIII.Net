...
namespace FireflyIIINet.Model
{
    ...
    public partial class TransactionSplit : IEquatable<TransactionSplit>, IValidatableObject
    {
        ...
        public TransactionSplit(TypeEnum type = default(TypeEnum), DateTime date = default(DateTime), int? order = default(int?), string currencyId = default(string), string currencyCode = default(string), string foreignCurrencyId = default(string), string foreignCurrencyCode = default(string), string amount = default(string), string foreignAmount = default(string), string description = default(string), string sourceId = default(string), string sourceName = default(string), AccountTypeProperty? sourceType = default(AccountTypeProperty?), string destinationId = default(string), string destinationName = default(string), AccountTypeProperty? destinationType = default(AccountTypeProperty?), string budgetId = default(string), string categoryId = default(string), string categoryName = default(string), string billId = default(string), string billName = default(string), bool reconciled = default(bool), string notes = default(string), List<string> tags = default(List<string>), string internalReference = default(string), string externalId = default(string), string bunqPaymentId = default(string), string sepaCc = default(string), string sepaCtOp = default(string), string sepaCtId = default(string), string sepaDb = default(string), string sepaCountry = default(string), string sepaEp = default(string), string sepaCi = default(string), string sepaBatchId = default(string), DateTime? interestDate = default(DateTime?), DateTime? bookDate = default(DateTime?), DateTime? processDate = default(DateTime?), DateTime? dueDate = default(DateTime?), DateTime? paymentDate = default(DateTime?), DateTime? invoiceDate = default(DateTime?), double? latitude = default(double?), double? longitude = default(double?), int? zoomLevel = default(int?))
        {
            this.Type = type;
            this.Date = date;
