...
namespace FireflyIIINet.Model
{
    ...
    public partial class RuleTriggerUpdate : IEquatable<RuleTriggerUpdate>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="type">The type of thing this trigger responds to. A limited set is possible.</param>
        ...
        public RuleTriggerUpdate(TypeEnum? type = default(TypeEnum?), string value = default(string), int order = default(int), bool active = default(bool), bool stopProcessing = default(bool))
        {
            this.Type = type;
            this.Value = value;
            this.Order = order;
