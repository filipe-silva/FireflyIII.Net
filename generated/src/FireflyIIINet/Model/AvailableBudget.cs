...
namespace FireflyIIINet.Model
{
    ...
    public partial class AvailableBudget : IEquatable<AvailableBudget>, IValidatableObject
    {
        ...
        public AvailableBudget(int currencyId = default(int), string currencyCode = default(string), string amount = default(string), DateTime start = default(DateTime), DateTime end = default(DateTime))
        {
