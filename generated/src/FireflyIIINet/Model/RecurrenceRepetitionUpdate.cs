...
namespace FireflyIIINet.Model
{
    ...
    public partial class RecurrenceRepetitionUpdate : IEquatable<RecurrenceRepetitionUpdate>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="type">The type of the repetition. ndom means: the n-th weekday of the month, where you can also specify which day of the week..</param>
        ...
        public RecurrenceRepetitionUpdate(TypeEnum? type = default(TypeEnum?), string moment = default(string), int skip = default(int), int weekend = default(int))
        {
            this.Type = type;
            this.Moment = moment;
            this.Skip = skip;
