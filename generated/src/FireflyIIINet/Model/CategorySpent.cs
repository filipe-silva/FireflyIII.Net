...
namespace FireflyIIINet.Model
{
    ...
    public partial class CategorySpent : IEquatable<CategorySpent>, IValidatableObject
    {
        ...
        public CategorySpent(DateTime start = default(DateTime), DateTime end = default(DateTime), int currencyId = default(int), string currencyCode = default(string), string currencySymbol = default(string), int currencyDecimalPlaces = default(int), string amount = default(string))
        {
            this.Start = start;
            this.End = end;
