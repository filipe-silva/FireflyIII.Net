...
namespace FireflyIIINet.Model
{
    ...
    public partial class Transaction : IEquatable<Transaction>, IValidatableObject
    {
        ...
        public Transaction(bool errorIfDuplicateHash = default(bool), bool applyRules = default(bool), string groupTitle = default(string), List<TransactionSplit> transactions = default(List<TransactionSplit>))
        {
