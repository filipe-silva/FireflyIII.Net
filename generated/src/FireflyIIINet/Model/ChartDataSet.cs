...
namespace FireflyIIINet.Model
{
    ...
    public partial class ChartDataSet : IEquatable<ChartDataSet>, IValidatableObject
    {
        ...
        public ChartDataSet(string label = default(string), string currencyId = default(string), string currencyCode = default(string), string currencySymbol = default(string), int currencyDecimalPlaces = default(int), string type = default(string), int yAxisID = default(int), List<ChartDataPoint> entries = default(List<ChartDataPoint>))
        {
            this.Label = label;
