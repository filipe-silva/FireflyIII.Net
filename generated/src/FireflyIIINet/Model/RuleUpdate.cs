...
namespace FireflyIIINet.Model
{
    ...
    public partial class RuleUpdate : IEquatable<RuleUpdate>, IValidatableObject
    {
        ...
        /// <param name="trigger">Which action is necessary for the rule to fire? Use either store-journal or update-journal..</param>
        ...
        public RuleUpdate(string title = default(string), string description = default(string), string ruleGroupId = default(string), int order = default(int), TriggerEnum? trigger = default(TriggerEnum?), bool active = default(bool), bool strict = default(bool), bool stopProcessing = default(bool), List<RuleTriggerUpdate> triggers = default(List<RuleTriggerUpdate>), List<RuleActionUpdate> actions = default(List<RuleActionUpdate>))
        {
            this.Title = title;
        ...
        {
            return this.Equals(input as RuleUpdate);
        }
