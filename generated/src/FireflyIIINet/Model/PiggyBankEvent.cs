...
namespace FireflyIIINet.Model
{
    ...
    public partial class PiggyBankEvent : IEquatable<PiggyBankEvent>, IValidatableObject
    {
        ...
        public PiggyBankEvent(DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), int currencyId = default(int), string currencyCode = default(string), string currencySymbol = default(string), int currencyDecimalPlaces = default(int), string amount = default(string), int journalId = default(int), int transactionId = default(int))
        {
