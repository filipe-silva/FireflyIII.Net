...
namespace FireflyIIINet.Model
{
    ...
    public partial class AutocompleteAccount : IEquatable<AutocompleteAccount>, IValidatableObject
    {
        ...
        /// <param name="currencyId">Currency ID for this account. (required).</param>
        /// <param name="currencyCode">Currency code for this account. (required).</param>
        /// <param name="currencySymbol">currencySymbol (required).</param>
        /// <param name="currencyDecimalPlaces">currencyDecimalPlaces (required).</param>
        public AutocompleteAccount(string id = default(string), string name = default(string), string nameWithBalance = default(string), string type = default(string), string currencyId = default(string), string currencyCode = default(string), string currencySymbol = default(string), int currencyDecimalPlaces = default(int))
        {
        ...
        /// </summary>
        /// <value>Currency ID for this account.</value>
        /// <example>12</example>
