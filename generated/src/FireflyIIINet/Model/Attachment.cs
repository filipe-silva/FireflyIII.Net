...
namespace FireflyIIINet.Model
{
    ...
    public partial class Attachment : IEquatable<Attachment>, IValidatableObject
    {
        ...
        public Attachment(AttachableTypeEnum attachableType = default(AttachableTypeEnum), string attachableId = default(string), string md5 = default(string), string filename = default(string), string downloadUrl = default(string), string uploadUrl = default(string), string title = default(string), string notes = default(string))
        {
