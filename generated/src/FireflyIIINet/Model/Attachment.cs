...
namespace FireflyIIINet.Model
{
    ...
    public partial class Attachment : IEquatable<Attachment>, IValidatableObject
    {
        ...
        public Attachment(string filename = default(string), AttachableTypeEnum attachableType = default(AttachableTypeEnum), string attachableId = default(string), string md5 = default(string), string downloadUri = default(string), string uploadUri = default(string), string title = default(string), string notes = default(string))
        {
