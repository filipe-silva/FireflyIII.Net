...
namespace FireflyIIINet.Model
{
    ...
    public partial class BudgetSpent : IEquatable<BudgetSpent>, IValidatableObject
    {
        ...
        public BudgetSpent(string sum = default(string), int currencyId = default(int), string currencyCode = default(string), string currencySymbol = default(string), int currencyDecimalPlaces = default(int))
        {
            this.Sum = sum;
