...
namespace FireflyIIINet.Model
{
    ...
    public partial class Account : IEquatable<Account>, IValidatableObject
    {
        ...
        public Account(string name = default(string), TypeEnum type = default(TypeEnum), string iban = default(string), string bic = default(string), string accountNumber = default(string), string openingBalance = default(string), DateTime openingBalanceDate = default(DateTime), string virtualBalance = default(string), int currencyId = default(int), string currencyCode = default(string), bool active = default(bool), int order = default(int), bool includeNetWorth = default(bool), AccountRoleEnum? accountRole = default(AccountRoleEnum?), CreditCardTypeEnum? creditCardType = default(CreditCardTypeEnum?), DateTime? monthlyPaymentDate = default(DateTime?), LiabilityTypeEnum? liabilityType = default(LiabilityTypeEnum?), string liabilityAmount = default(string), DateTime liabilityStartDate = default(DateTime), string interest = default(string), InterestPeriodEnum? interestPeriod = default(InterestPeriodEnum?), string notes = default(string))
        {
