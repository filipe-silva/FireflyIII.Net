...
namespace FireflyIIINet.Model
{
    ...
    public partial class RecurrenceTransactionUpdate : IEquatable<RecurrenceTransactionUpdate>, IValidatableObject
    {
        ...
        public RecurrenceTransactionUpdate(string description = default(string), string amount = default(string), string foreignAmount = default(string), string currencyId = default(string), string currencyCode = default(string), string foreignCurrencyId = default(string), string budgetId = default(string), string categoryId = default(string), string sourceId = default(string), string destinationId = default(string), List<string> tags = default(List<string>), string piggyBankId = default(string), string billId = default(string))
        {
