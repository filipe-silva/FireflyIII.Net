...
namespace FireflyIIINet.Model
{
    ...
    public partial class Currency : IEquatable<Currency>, IValidatableObject
    {
        ...
        public Currency(bool enabled = default(bool), bool varDefault = default(bool), string code = default(string), string name = default(string), string symbol = default(string), int decimalPlaces = default(int))
        {
