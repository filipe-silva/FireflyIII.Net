...
namespace FireflyIIINet.Model
{
    ...
    public partial class RuleStore : IEquatable<RuleStore>, IValidatableObject
    {
        ...
        public RuleStore(string title = default(string), string description = default(string), string ruleGroupId = default(string), string ruleGroupTitle = default(string), int order = default(int), TriggerEnum trigger = default(TriggerEnum), bool active = default(bool), bool strict = default(bool), bool stopProcessing = default(bool), List<RuleTriggerStore> triggers = default(List<RuleTriggerStore>), List<RuleActionStore> actions = default(List<RuleActionStore>))
        {
