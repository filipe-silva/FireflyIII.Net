...
namespace FireflyIIINet.Model
{
    ...
    public partial class TransactionSplitStore : IEquatable<TransactionSplitStore>, IValidatableObject
    {
        ...
        public TransactionSplitStore(TypeEnum type = default(TypeEnum), DateTime date = default(DateTime), string amount = default(string), string description = default(string), int? order = default(int?), string currencyId = default(string), string currencyCode = default(string), string foreignAmount = default(string), string foreignCurrencyId = default(string), string foreignCurrencyCode = default(string), string budgetId = default(string), string categoryId = default(string), string categoryName = default(string), string sourceId = default(string), string sourceName = default(string), string destinationId = default(string), string destinationName = default(string), bool reconciled = default(bool), int piggyBankId = default(int), string piggyBankName = default(string), string billId = default(string), string billName = default(string), List<string> tags = default(List<string>), string notes = default(string), string internalReference = default(string), string externalId = default(string), string bunqPaymentId = default(string), string sepaCc = default(string), string sepaCtOp = default(string), string sepaCtId = default(string), string sepaDb = default(string), string sepaCountry = default(string), string sepaEp = default(string), string sepaCi = default(string), string sepaBatchId = default(string), DateTime? interestDate = default(DateTime?), DateTime? bookDate = default(DateTime?), DateTime? processDate = default(DateTime?), DateTime? dueDate = default(DateTime?), DateTime? paymentDate = default(DateTime?), DateTime? invoiceDate = default(DateTime?))
        {
            ...
            if (sourceId == null)
            {
                throw new ArgumentNullException("sourceId is a required property for TransactionSplitStore and cannot be null");
            }
            this.SourceId = sourceId;
            // to ensure "destinationId" is required (not null)
            if (destinationId == null)
            {
                throw new ArgumentNullException("destinationId is a required property for TransactionSplitStore and cannot be null");
            }
        ...
        {
            return this.Equals(input as TransactionSplitStore);
        }
