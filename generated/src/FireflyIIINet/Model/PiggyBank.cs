...
namespace FireflyIIINet.Model
{
    ...
    public partial class PiggyBank : IEquatable<PiggyBank>, IValidatableObject
    {
        ...
        public PiggyBank(string name = default(string), int accountId = default(int), string targetAmount = default(string), string currentAmount = default(string), DateTime startDate = default(DateTime), DateTime targetDate = default(DateTime), int order = default(int), string notes = default(string), int objectGroupId = default(int), int objectGroupOrder = default(int), string objectGroupTitle = default(string))
        {
