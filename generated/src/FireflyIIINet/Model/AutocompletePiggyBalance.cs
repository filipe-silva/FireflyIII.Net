...
namespace FireflyIIINet.Model
{
    ...
    public partial class AutocompletePiggyBalance : IEquatable<AutocompletePiggyBalance>, IValidatableObject
    {
        ...
        public AutocompletePiggyBalance(string id = default(string), string name = default(string), string nameWithBalance = default(string), string objectGroupId = default(string), string objectGroupTitle = default(string), string currencyId = default(string), string currencyCode = default(string), string currencySymbol = default(string), int currencyDecimalPlaces = default(int))
        {
