...
namespace FireflyIIINet.Model
{
    ...
    public partial class BudgetLimit : IEquatable<BudgetLimit>, IValidatableObject
    {
        ...
        public BudgetLimit(int currencyId = default(int), string currencyCode = default(string), int budgetId = default(int), DateTime start = default(DateTime), DateTime end = default(DateTime), string amount = default(string))
        {
