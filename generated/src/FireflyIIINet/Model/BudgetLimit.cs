...
namespace FireflyIIINet.Model
{
    ...
    public partial class BudgetLimit : IEquatable<BudgetLimit>, IValidatableObject
    {
        ...
        public BudgetLimit(string currencyId = default(string), string currencyCode = default(string), DateTime start = default(DateTime), DateTime end = default(DateTime), string amount = default(string))
        {
            this.Start = start;
            this.End = end;
