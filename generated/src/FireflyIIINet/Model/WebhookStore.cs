...
namespace FireflyIIINet.Model
{
    ...
    public partial class WebhookStore : IEquatable<WebhookStore>, IValidatableObject
    {
        ...
        public WebhookStore(bool active = default(bool), string title = default(string), TriggerEnum trigger = default(TriggerEnum), ResponseEnum response = default(ResponseEnum), DeliveryEnum delivery = default(DeliveryEnum), string url = default(string))
        {
