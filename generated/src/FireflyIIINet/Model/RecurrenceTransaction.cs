...
namespace FireflyIIINet.Model
{
    ...
    public partial class RecurrenceTransaction : IEquatable<RecurrenceTransaction>, IValidatableObject
    {
        ...
        public RecurrenceTransaction(string description = default(string), string amount = default(string), string foreignAmount = default(string), int currencyId = default(int), string currencyCode = default(string), int? foreignCurrencyId = default(int?), string foreignCurrencyCode = default(string), int budgetId = default(int), int categoryId = default(int), string categoryName = default(string), int sourceId = default(int), string sourceName = default(string), AccountTypeProperty? sourceType = default(AccountTypeProperty?), int destinationId = default(int), string destinationName = default(string), AccountTypeProperty? destinationType = default(AccountTypeProperty?), List<string> tags = default(List<string>), int piggyBankId = default(int), string piggyBankName = default(string))
        {
