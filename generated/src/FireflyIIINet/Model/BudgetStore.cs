...
namespace FireflyIIINet.Model
{
    ...
    public partial class BudgetStore : IEquatable<BudgetStore>, IValidatableObject
    {
        ...
        public BudgetStore(string name = default(string), bool active = default(bool), AutoBudgetType? autoBudgetType = default(AutoBudgetType?), string autoBudgetCurrencyId = default(string), string autoBudgetCurrencyCode = default(string), string autoBudgetAmount = default(string), AutoBudgetPeriod? autoBudgetPeriod = default(AutoBudgetPeriod?))
        {
