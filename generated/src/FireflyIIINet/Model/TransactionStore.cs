...
namespace FireflyIIINet.Model
{
    ...
    public partial class TransactionStore : IEquatable<TransactionStore>, IValidatableObject
    {
        ...
        public TransactionStore(bool errorIfDuplicateHash = default(bool), bool applyRules = default(bool), string groupTitle = default(string), List<TransactionSplitStore> transactions = default(List<TransactionSplitStore>))
        {
