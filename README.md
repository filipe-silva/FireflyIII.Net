...
- API version: 6.2.10 (v1 and v2 endpoints)
- SDK version: 6.2.10 (tracks the API version; the 4th revision component denotes client-only changes)
- Source specifications: [api/firefly-iii-6.2.10-v1.yaml](api/firefly-iii-6.2.10-v1.yaml) and [api/firefly-iii-6.2.10-v2.yaml](api/firefly-iii-6.2.10-v2.yaml)
