...
- API version: 6.4.4 (v1 endpoints, plus the two v2 endpoints last documented in 6.2.21)
- SDK version: 6.4.4 (tracks the API version; the 4th revision component denotes client-only changes)
- Source specification: [api/firefly-iii-6.4.4-v1.yaml](api/firefly-iii-6.4.4-v1.yaml) (upstream stopped publishing v2 specs after 6.2.21)
